...
//Adding an event listener to trigger when the button is clicked, gathers input values, calls an API search and renders the list to the DOM.
...
//Function to run through all recipes that appear in api search, loop through each recipe, create a div container for all recipes in the search and create a className for the container.
